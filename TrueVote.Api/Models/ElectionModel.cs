...
namespace TrueVote.Api.Models
{
    ...
    public class ElectionModel
    {
        ...
        required public string HeaderImageUrl { get; set; } = string.Empty;
        ...
        required public ICollection<RaceModel> Races { get; set; } = new List<RaceModel>();
    }
    ...
    public class ElectionObj
    {
        ...
        private readonly List<ElectionModelResponse>? election;
    }
    ...
    public class ElectionModelList
    {
        ...
        required public List<ElectionModel> Elections { get; set; }
    }
    ...
    public class ElectionModelResponse
    {
        ...
        [JsonProperty(nameof(ElectionId), Required = Required.Always)]
        [Key]
        required public string ElectionId { get; set; } = Guid.NewGuid().ToString();
    ...
    public class AddRacesModel
    {
        ...
        required public List<string> RaceIds { get; set; }
    }
}
